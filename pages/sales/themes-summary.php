...
Capex intensity (capex/assets)*/
        ...
        $list = 'tsales:Total sales;top3:% top 3;top5:% top 5;stability:Stability;roic:ROIC;pe:PE;evebitda:EVBIDTA;payout:Payout;y3sales:3yr Sales growth;y3ebit:3yr EBIT growth;y3assets:3yr Asset growth;y3capex:3yr Capex growth;sales_growth:Sales growth (1);grwsales:Sales growth;grwebit:EBIT growth;grwassets:Asset growth;grwcapex:Capex growth;ebit-by-assets:ROA;capex-by-assets:Capex intensity;sales-by-assets:Asset turnover';
        ?>
